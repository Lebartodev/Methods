 ...
 */
public class SysNewton {
    double x, y,eps;

    public SysNewton(double x, double y, double eps) {
        this.x = x;
        this.y = y;
        this.eps=eps;
        calculate();
    ...
    void nuton(double x, double y,double eps) {
        ...
        do {
            a[0][0] = Function.dfunc1x(x, y);
            a[1][0] = Function.dfunc1y(x, y);
            a[0][1] = Function.dfunc2x(x, y);
            a[1][1] = Function.dfunc2y(x, y);
            a = ober_matr(a);
